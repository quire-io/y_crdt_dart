...
void main() {
  ...
  group('YText', () {
    test('delta bug', () {
      testDeltaBug(t.TestCase('y_text', 'delta bug'));
    });

    test('delta bug2', () {
      testDeltaBug2(t.TestCase('y_text', 'delta bug2'));
    });

    test('delta after concurrent formatting', () {
      testDeltaAfterConcurrentFormatting(t.TestCase('y_text', 'delta after concurrent formatting'));
    });

    test('basic insert and delete', () {
      testBasicInsertAndDelete(t.TestCase('y_text', 'basic insert and delete'));
    });

    test('basic format', () {
      testBasicFormat(t.TestCase('y_text', 'basic format'));
    });

    test('falsy formats', () {
      testFalsyFormats(t.TestCase('y_text', 'falsy formats'));
    });

    test('multiline format', () {
      testMultilineFormat(t.TestCase('y_text', 'multiline format'));
    });

    test('not merge empty lines format', () {
      testNotMergeEmptyLinesFormat(t.TestCase('y_text', 'not merge empty lines format'));
    });

    test('preserve attributes through delete', () {
      testPreserveAttributesThroughDelete(t.TestCase('y_text', 'preserve attributes through delete'));
    });

    test('get delta with embeds', () {
      testGetDeltaWithEmbeds(t.TestCase('y_text', 'get delta with embeds'));
    });
 ...
 */
void testDeltaBug(t.TestCase _tc) {
  final initialDelta = [{
    'attributes': {
 ...
 * @param {t.TestCase} _tc
 */
void testDeltaBug2(t.TestCase _tc) {
  final initialContent = [
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-8a1d2bb6-23c2-4bcf-af3c-3919ffea1697"
      }
    },
    {
      "insert": "\n\n",
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-15b4483c-da98-4ded-91d3-c3d6ebc82582"
      }
    },
    {
      "insert": {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-68552c8e-b57b-4f4a-9f36-6cc1ef6b3461"
      }
    },
    {
      "insert": "jklasjdf"
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-be18141c-9b6b-434e-8fd0-2c214437d560"
      }
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-36922db3-4af5-48a1-9ea4-0788b3b5d7cf"
      }
    },
    {
      "insert": {
    ...
    },
    {
      ...
      "attributes": {
        ...
        "layout": "12d887e1-d1a2-4814-a1a3-0c904e950b46_1185cd29-ef1b-45d5-8fda-51a70b704e64",
        "layout-width": "0.25"
      }
    },
    {
      ...
      "attributes": {
        ...
        "layout": "12d887e1-d1a2-4814-a1a3-0c904e950b46_75523ea3-c67f-4f5f-a85f-ac7c8fc0a992",
        "layout-width": "0.5"
      }
    },
    {
      ...
      "attributes": {
        ...
        "layout": "12d887e1-d1a2-4814-a1a3-0c904e950b46_54c740ef-fd7b-48c6-85aa-c14e1bfc9297",
        "layout-width": "0.25"
      }
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-2d6ff0f4-ff00-42b7-a8e2-b816463d8fb5"
      }
    },
    {
      "insert": {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-7fa64af0-6974-4205-8cee-529f8bd46852"
      }
    },
    {
      "insert": {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-30ef8361-0dd6-4eee-b4eb-c9012d0e9070"
      }
    },
    {
      "insert": {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-166ed856-cf8c-486a-9365-f499b21d91b3"
      }
    },
    {
      "insert": {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-fbf23cab-1ce9-4ede-9953-f2f8250004cf"
      }
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-c3fbb8c9-495c-40b0-b0dd-f6e33dd64b1b"
      }
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-3417ad09-92a3-4a43-b5db-6dbcb0f16db4"
      }
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-b9eacdce-4ba3-4e66-8b69-3eace5656057"
      }
    },
    {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-814521bd-0e14-4fbf-b332-799c6452a624"
      }
    },
    {
      "insert": "aaa"
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-18bf68c3-9ef3-4874-929c-9b6bb1a00325"
      }
    },
    {
      "insert": "\n",
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-28f28cb8-51a2-4156-acf9-2380e1349745"
      }
    },
    {
      "insert": {
    ...
    },
    {
      "insert": "\n",
      "attributes": {
        "block-id": "block-a1193252-c0c8-47fe-b9f6-32c8b01a1619"
      }
    },
    {
      "insert": "\n",
  ...
  final delta = ytext.toDelta();
  expect(delta[41], equals({
    'insert': '\n',
    'attributes': {
      'block-id': 'block-9d6566a1-be55-4e20-999a-b990bc15e143'
    }
 ...
 * @param {t.TestCase} tc
 */
void testDeltaAfterConcurrentFormatting(t.TestCase tc) {
...
void testBasicInsertAndDelete(t.TestCase tc) {
  ...
  text0.delete(0, 0);
  // expect(true, 'Does not throw when deleting zero elements with position 0')

  text0.insert(0, 'abc');
  expect(text0.toString(), 'abc', reason: 'Basic insert works');
  expect(delta, equals([{ 'insert': 'abc' }]));

  text0.delete(0, 1);
  expect(text0.toString(), 'bc', reason: 'Basic delete works (position 0)');
  expect(delta, equals([{ 'delete': 1 }]));

  text0.delete(1, 1);
  expect(text0.toString(), 'b', reason: 'Basic delete works (position 1)');
  expect(delta, equals([{ 'retain': 1 }, { 'delete': 1 }]));
...
void testBasicFormat(t.TestCase tc) {
  ...
  expect(text0.toDelta(), equals([{ 'insert': 'abc', 'attributes': { 'bold': true } }]));
  expect(delta, equals([{ 'insert': 'abc', 'attributes': { 'bold': true } }]));
  text0.delete(0, 1);
  expect(text0.toString(), 'bc', reason: 'Basic delete on formatted works (position 0)');
  expect(text0.toDelta(), equals([{ 'insert': 'bc', 'attributes': { 'bold': true } }]));
  expect(delta, equals([{ 'delete': 1 }]));
  text0.delete(1, 1);
  expect(text0.toString(), 'b', reason: 'Basic delete works (position 1)');
  expect(text0.toDelta(), equals([{ 'insert': 'b', 'attributes': { 'bold': true } }]));
  expect(delta, equals([{ 'retain': 1 }, { 'delete': 1 }]));
  text0.insert(0, 'z', { 'bold': true });
  expect(text0.toString(), 'zb', reason: 'Basic insert works (position 0)');
  expect(text0.toDelta(), equals([{ 'insert': 'zb', 'attributes': { 'bold': true } }]));
  expect(delta, equals([{ 'insert': 'z', 'attributes': { 'bold': true } }]));
  // @ts-ignore
  expect((text0.innerStart!.right!.right!.right!.content as y.ContentString).str, 
    'b', reason: 'Does not insert duplicate attribute marker');
  text0.insert(0, 'y');
  expect(text0.toString(), 'yzb');
  expect(text0.toDelta(), equals([{ 'insert': 'y' }, { 'insert': 'zb', 'attributes': { 'bold': true } }]));
  expect(delta, equals([{ 'insert': 'y' }]));
  text0.format(0, 2, { 'bold': null });
  expect(text0.toString(), 'yzb');
  expect(text0.toDelta(), equals([{ 'insert': 'yz' }, { 'insert': 'b', 'attributes': { 'bold': true } }]));
  expect(delta, equals([{ 'retain': 1 }, { 'retain': 1, 'attributes': { 'bold': null } }]));
  compare(users);
}
 ...
 * @param {t.TestCase} tc
 */
void testFalsyFormats(t.TestCase tc) {
  final results = init(tc, users: 2 ),
    users = results['users'] as List,
    text0 = results['text0'] as YText;
  var delta;
 ...
 * @param {t.TestCase} _tc
 */
void testMultilineFormat(t.TestCase _tc) {
  final ydoc = y.Doc();
  final testText = ydoc.getText('test');
 ...
 * @param {t.TestCase} _tc
 */
void testNotMergeEmptyLinesFormat(t.TestCase _tc) {
  final ydoc = y.Doc();
  final testText = ydoc.getText('test');
  testText.applyDelta([
    { 'insert': 'Text' },
 ...
 * @param {t.TestCase} _tc
 */
void testPreserveAttributesThroughDelete(t.TestCase _tc) {
  final ydoc = y.Doc();
  final testText = ydoc.getText('test');
  testText.applyDelta([
    { 'insert': 'Text' },
 ...
 * @param {t.TestCase} tc
 */
void testTypesAsEmbed(t.TestCase tc) {
  final results = init(tc, users: 2),
    testConnector = results['testConnector'] as TestConnector,
    text0 = results['text0'] as YText,
    text1 = results['text1'] as YText;
  text0.applyDelta([{
    'insert': y.YMap([MapEntry('key', 'val')])
  }]);
  expect((text0.toDelta()[0]['insert'] as y.YMap).toJSON(), equals({ 'key': 'val' }));
  var firedEvent = false;
  text1.observe((event, _) {
    final d = event.delta;
    expect(d.length, 1);
    expect(d.map((x) => /** @type {Y.AbstractType<any>} */ x.toJson()['insert']), 
      equals([{ 'key': 'val' }]));
    firedEvent = true;
  });
  testConnector.flushAllMessages();
  final delta = text1.toDelta();
